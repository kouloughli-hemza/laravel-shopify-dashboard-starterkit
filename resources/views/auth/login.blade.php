...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p" id="login">
    ...
    <div class="card mt-5">
        <div class="card-body">
            ...
            <div class="p-4">
                ...
                <form role="form" action="<?= url('dashboard/login') ?>" method="POST" id="login-form" autocomplete="off" class="mt-3">
    ...
    <div class="text-center text-muted">
        @if (setting('reg_enabled'))
            ...
            <a class="font-weight-bold" href="<?= url("dashboard/register") ?>">@lang('Sign Up')</a>
        @endif
    </div>
</div>
